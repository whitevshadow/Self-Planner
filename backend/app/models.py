...
class Meeting(Base):
    ...
    notes: Mapped[str | None] = mapped_column(Text)  # full meeting minutes (Markdown, per skill.md)
    ...
    # {"stage": "summary"|"extract", "done": int, "total": int} while extraction runs, else NULL
    extract_progress: Mapped[dict | None] = mapped_column(JSONB)
